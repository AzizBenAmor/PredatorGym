<div>
    <div>
        <div class="ml-28 mb-6">
          <button wire:click='addActivity' type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Add Activity</button>
         </div>
        <section class="pl-28 ">
